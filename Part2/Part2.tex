...
On distingue généralement les intervalles décrit dans le tableau \ref{definition} \cite[p.59]{acoustique} pour juger de la qualité de la définition sonore dans une salle en fonction de la valeur mesurée ou calculée du critère  $D_{50}$. 

\begin{tableth} \label{tab_definition}
	\begin{tabular}{| *{7}{c|}}
		\hline
		 \gls{D50} & 0 à 30\% & 0 à 30\%& 30 à 45\%& 45 à 60\%& 60 à 75\% & 75 à 100\%\\
		  \hline
...
\begin{equation}
E'(t) =  E(t) \frac{ 10^{-3,1}e^{-m.t.v}}{(t.v)^2},
\end{equation}
avec :
\begin{itemize}
