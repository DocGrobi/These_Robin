...
\let\oldcite\cite
\renewcommand*\cite[2][oeuvre intégrale]{\footnote{\oldcite[#1]{#2}}\futurelet\nextToken\iscite}
\let\oldcitep\citep
\renewcommand*\citep[2][oeuvre intégrale]{\footnote{\oldcitep[#1]{#2}}\futurelet\nextToken\iscite}
\newcommand*\citefnt[2][oeuvre intégrale]{\footnotetext{\oldcite[#1]{#2}}\futurelet\nextToken\iscite}
