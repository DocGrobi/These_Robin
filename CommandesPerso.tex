...
%% Theorème
\newtheorem{theo}{Règle des cotes contradictoires :} 
\labelformat{theo}{règle des cotes contradictoires}
\renewcommand{\thetheo}{}
...
%Pour mettre une virgule entre deux footnotes
\newcommand\nextToken\relax
\newcommand\iscite{\ifx\cite\nextToken\textsuperscript{,}\fi}

%Macro pour mettre les citations en bas de page
\let\oldcite\cite
\renewcommand*\cite[2][]{\footnote{\oldcite[#1]{#2}}\futurelet\nextToken\iscite}
\let\oldcitep\citep
\renewcommand*\citep[2][]{\footnote{\oldcitep[#1]{#2}}\futurelet\nextToken\iscite}
\newcommand*\citefnt[2][]{\footnotetext{\oldcite[#1]{#2}}\futurelet\nextToken\iscite}
