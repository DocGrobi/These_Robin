...
\newglossaryentry{OBB}{
	...
	first={\textit{Oriented Bounding Box} (OBB)},
	}		
...
\newglossaryentry{Dirac}{
	name={\scshape{Dirac}},
	text   = {Dirac},
	description={La distribution de Dirac peut être informellement considérée comme une fonction qui prend une « valeur » infinie en 0, et la valeur zéro partout ailleurs
	% vérifie la propriété fondamentale que, pour toute fonction :$x \mapsto  \varphi (x)$ lisse : $< \delta , \varphi > = \varphi(0)$
	},
	}	
...
\newglossaryentry{octree}{
	name={\scshape{Octree}},
	text   = {\textit{octree}},
	description={Structure de données de type arbre dans laquelle chaque nœud peut compter jusqu'à huit enfants. En trois dimensions, créer un \gls{octree} revient à découper un cube en son milieu sur chacun de ses axes},
	}
...
\newglossaryentry{armature}{
	...
	text   = {armature},
	description={Une armature dans \textit{Blender} peut être considérée comme semblable à l’armature d’un vrai squelette, et tout comme un squelette réel, elle peut être constituée de nombreux os. Ceux-ci peuvent être déplacés et tout ce à quoi ils sont attachés ou associés se déplacera et se déformera de manière similaire \footnote{Manuel \textit{Blender} - Armatures}}
	}

\newglossaryentry{array}{
	name={\scshape{Modificateur "Tableau"}},
	text   = {modificateur de type "Tableau"},
	description={Permet de répéter plusieurs fois un objet en disposant les copies dans le repère absolu, le repère relatif à l'objet source ou bien par rapport à un objet tiers%. Il est par exemple utilisé pour créer des escaliers en répétant n fois la première marche. Pour répéter l'objet selon une courbe, on peut lier le modificateur à un objet vide (empty) qui aura subit une rotation. Cela est utilisé par exemple pour répéter les colonnes de la \gls{porticus isc}
	},
	first={Modificateur "Tableau" qui permet de répéter plusieurs fois un objet}
	}
	
\newglossaryentry{boolean}{
	name={\scshape{Modificateur "Booléen"}},
	text   = {modificateur de type "Booléen"},
	...
	first={Modificateur "Booléen" qui permet des opérations d'addition, de soustraction ou d'intersection entre objets}
	}

\newglossaryentry{decimate}{
	name={\scshape{modificateur "Décimer"}},
	text   = {modificateur de type "Décimer"},
...
\newglossaryentry{mirror}{
	name={\scshape{Modificateur "Miroir"}},
	text   = {modificateur de type "Miroir"},
	...
	first={Modificateur "miroir" (qui permet de recopier des objets en symétrie)}
	}	

\newglossaryentry{modifier}{
	name={\scshape{Modificateur}},
	text   = {modificateur},
	description={Outil \textit{Blender} permettant d'affecter automatiquement à des objets des opérations non-destructives},
	}
...
\newglossaryentry{screw}{
	name={\scshape{Modificateur "Visser"}},
	text   = {modificateur de type "Visser"},
	...
	first={Modificateur "Visser" qui permet de faire une extrusion circulaire autour du centre de l'objet}
	}	
	
\newglossaryentry{solidify}{
	name={\scshape{Modificateur "Solidifier"}},
	text   = {modificateur de type "Solidifier"},
	...
	first={Modificateur "Solidifier" qui permet de donner une épaisseur paramétrable à un objet plan}
	}	
		
	
%% ARCHEO

\newglossaryentry{aulos}{
	name={\scshape{Aulos}},
	text={\textit{aulos}},
	description={Instrument à vent précurseur du hautbois, très utilisé durant toute l'Antiquité au cours de rites religieux et sociaux. Appelé \textit{aulos} dans la Grèce antique et \textit{tibia} dans la Rome antique, c'est un instrument à anche battante, simple ou double, composé principalement d'un tuyau percé de trous, joué le plus souvent par paires},
	%plural={\textit{aditi}},
	}
...
\newglossaryentry{aretier}{
	...
	text={arêtier},
	description={Pièce de charpente ou d'étanchéité qui forme l’angle saillant ou l’arête de la croupe d’un toit},
	}	
	
\newglossaryentry{ambulacre}{
	name={\scshape{Ambulacre}},
	text={am\-bulacre},
	description={Galerie circulaire permettant de se déplacer sous la \gls{cavea}},
	}	
...
\newglossaryentry{balteus}{
	...
	text={\textit{balteus}},
	description={Balustrade de pierre qui ceinturait l'arrière de l'\gls{orchestra} et le séparait de la \gls{cavea}. Il ménageait un couloir de circulation au pied de la \gls{cavea} et isolait les sièges des notables placés sur les gradins de l'\gls{orchestra}},
	plural={\textit{baltei}},
	}	
...
\newglossaryentry{ima cavea}{
	...
	description={Désigne le premier niveau (niveau inférieur) de la \gls{cavea}},
	}

\newglossaryentry{media cavea}{
	name={\scshape{Media cavea}},
	text={\textit{media cavea}},
	description={Désigne le deuxième niveau (niveau médian) de la \gls{cavea}},
	}
	
\newglossaryentry{summa cavea}{
	name={\scshape{Summa cavea}},
	text={\textit{summa cavea}},
	description={Désigne le troisième niveau (niveau supérieur) de la \gls{cavea}},
	}	
...
\newglossaryentry{hyposcaenium}{
	...
	description={Fosse située sous la scène comportant notamment le mécanisme du rideau de scène},
	}
	
\newglossaryentry{maenianum}{
	name={\scshape{Maenianum}},
	text={\textit{maenianum}},
	description={Portion de la \gls{cavea} séparée par un \gls{podium} et rassemblant un ensemble de gradins},
