...
\newglossaryentry{basilique}{
	...
	description={
	\begin{center}
		\includegraphics[width=0.4\linewidth]{glossaire/basiliques}
	\end{center}
	Large pièce de forme quasi-carré qui flanque le mur de scène et les \gls{parascaenium}},
	}

\newglossaryentry{balteus}{
	name={\scshape{Blateus}},
	text={balteus},
	description={Mur de pierre ne dépassant pas un mètre de hauteur qui ceinturait l'arrière de l'\gls{orchestra} et le séparait de la \gls{cavea}. Il ménageait un couloir de circulation au pied de la \gls{cavea} et isolait les sièges des notables placés sur les gradins de l'\gls{orchestra}},
	}	
...
\newglossaryentry{postscaenium}{
	...
	\begin{center}
		\includegraphics[width=0.4\linewidth]{glossaire/frondescene}
		\includegraphics[width=0.4\linewidth]{glossaire/murnord}
	\end{center}},
	}
