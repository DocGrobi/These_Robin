...
\newglossaryentry{armature}{
	...
	text   = {armature},
	description={Une Armature dans \textit{Blender} peut être considérée comme semblable à l’armature d’un vrai squelette, et tout comme un squelette réel, une Armature peut être constituée de nombreux Os. Ces Os peuvent être déplacés et tout ce à quoi ils sont attachés ou associés se déplacera et se déformera de manière similaire \footnote{Manuel \textit{Blender} - Armatures}}
	}
